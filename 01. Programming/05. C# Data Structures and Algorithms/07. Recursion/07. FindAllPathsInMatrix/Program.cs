...
namespace _07.FindAllPathsInMatrix
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            FindPathToTheExit(0, 0, 'S', matrix);
        ...
        private static void FindPathToTheExit(int row, int col, char direction, char[,] matrix)
        {
            ...
            if (matrix[row, col] == 'E')
            {
                ...
                Console.ForegroundColor = ConsoleColor.Green;
                Console.WriteLine("Solution " + countOfSolutions + ": ");
                Console.ResetColor();
                PrintTheMatrix(matrix);
            ...
            if (matrix[row, col] == 0)
            {
                ...
                FindPathToTheExit(row, col - 1, 'L', matrix); // left
                FindPathToTheExit(row - 1, col, 'U', matrix); // up
                FindPathToTheExit(row, col + 1, 'R', matrix); // right
                FindPathToTheExit(row + 1, col, 'D', matrix); // down
