...
namespace HashTableImplementation
{
    public class HashTable<K, T> : IEnumerable<KeyValuePair<K, T>>
    {
        private const string CapacityZeroOrNegativeErrorMessage = 
            "Initial JHashTable size can not be less than or equal to 0!";
        ...
        public HashTable(int capacity, HashTable<K, T> HashTable)
            : this(capacity)
        {
        ...
        private void CheckAndGrow()
        {
            ...
            {
                var newJHashTable = new HashTable<K, T>(this.buckets.Length * 2);
