...
{
    public class Matrix<T> where T : IComparable // Task 8
    {
        ...
        public static Matrix<T> operator +(Matrix<T> firstMatrix, Matrix<T> secondMatrix) // Task 10
        {
        ...
        public static bool operator true(Matrix<T> matrix) // Task 10
        {
        ...
        public static bool operator false(Matrix<T> matrix) // Task 10
        {
            if (matrix == null || matrix.Rows == 0 || matrix.Cols == 0)
            {
                return true;
